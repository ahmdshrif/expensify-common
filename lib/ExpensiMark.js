...
export default class ExpensiMark {
        ...
        this.htmlToMarkdownRules = [
            ...
            },
            {
                ...
                pre: inputString =>{  
                    ...
                    .replaceAll(/(<tr.*?<\/tr>)/g,`$1<br/>`).replaceAll('<br/></tbody>',"")
    ...
    mapBlock (htmlString){
        ...
        for (let index = 1; index < splitText.length -1; index++) {
            if (splitText[index].trim() ) {
                joinedText += splitText[index]+ '\n'
            }else if (splitText[index].trim()){
                joinedText += splitText[index]
            }
        }
        return joinedText
    ...
    htmlToMarkdown(htmlString) {
        ...
        generatedMarkdown = generatedMarkdown.replaceAll(/<div.*?>|<\/div>|<comment.*?>|<\/comment>/gm,"[block]")
